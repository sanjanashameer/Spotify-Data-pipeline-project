...
sp = spotipy.Spotify(auth_manager=SpotifyClientCredentials(
    client_id='8a6cb4aa61e74cd9b044cbd914e66df0',  # Replace with your Client ID
    client_secret='0d28dd666696490cb5e7d6caa455db6e'  # Replace with your Client Secret
))
...
db_config = {
    ...
    'password': '7171',   # Replace with your MySQL password
